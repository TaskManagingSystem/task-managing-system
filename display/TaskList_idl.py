...
_0__GlobalIDL._d_TaskList  = (omniORB.tcInternal.tv_struct, TaskList, TaskList._NP_RepositoryId, "TaskList", "tm", omniORB.typeMapping["IDL:RTC/Time:1.0"], "task_id", omniORB.tcInternal.tv_long, "start_time", omniORB.tcInternal.tv_char, "finish_time", omniORB.tcInternal.tv_char, "target", omniORB.tcInternal.tv_long, "status", omniORB.tcInternal.tv_boolean, "title", omniORB.tcInternal.tv_char, "discription", omniORB.tcInternal.tv_char)
