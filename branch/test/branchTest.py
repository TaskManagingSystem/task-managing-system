...
branchtest_spec = ["implementation_id", "branchTest", 
         "type_name",         "branchTest", 
...
# 
# </rtc-template>
class branchTest(OpenRTM_aist.DataFlowComponentBase):
    ...
    def __init__(self, manager):
        ...
        """
        """
        self._input_buttonOut = OpenRTM_aist.OutPort("input_button", self._d_input_button)
    ...
    def onInitialize(self):
        ...
        self.addOutPort("input_button",self._input_buttonOut)
...
def RunTest():
    ...
    comp = manager.getComponent("branchTest0")
    if comp is None:
        print('Component get failed.', file=sys.stderr)
        return False
    return comp.runTest()

def branchTestInit(manager):
    profile = OpenRTM_aist.Properties(defaults_str=branchtest_spec)
    manager.registerFactory(profile,
                            branchTest,
                            OpenRTM_aist.Delete)

def MyModuleInit(manager):
    branchTestInit(manager)
    branch.branchInit(manager)

    # Create a component
    comp = manager.createComponent("branchTest")
